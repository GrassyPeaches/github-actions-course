...
if(!validateBranchName({branchName: targetBranchBranch})) {
...
/*
  [DONE]1.Parse inputs: 
      1.1 base branch from which to check updates
      1.2 target branch to use to create the PR
      1.3 Github token for authentication (to create PRs for example)
      1.4 Working directory for which to check dependencies
  [DONE]2. Execute the npm udate command within the working directory
